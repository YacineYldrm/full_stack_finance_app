...
const GetStarted = () => {
    ...
    return ( 
        <main>
            <section>
                <article>
                    <img src={smallPresent} alt="" />
                    <img src={shadowSmallPresent} alt="" />
                    <img src={middlePresent} alt="" />
                    <img src={shadowMiddlePresent} alt="" />
                    <img src={bigPresent} alt="" />
                    <img src={shadowBigPresent} alt="" />
                    <img src={bigPresentShadow} alt="" />
                    <div>
                        <img src={upperBodyCard} alt="" />
                        <img src={magneticStripe} alt="" />
                        <img src={underBodyCard} alt="" />
                    </div>
                    <img src={cardShadow} alt="" />
                </article>
            ...
            <section>
                <div>
                    ...
                    <p>Get started with Finco and dive into a comprehensive analysis of your spending habits. Gain valuable insights, take control of your finances, and embark on your journey to financial empowerment.</p>
                </div>
                <div>
                    
                    <Button btnContent={`Get Started &rarr;`} btnFunction={navigate("/register")}/>
