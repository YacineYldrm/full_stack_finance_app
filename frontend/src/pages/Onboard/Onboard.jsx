    ...
    return ( 
        ...
        <main>
            <section>
                <article>
                    <img src={bills} alt="" />
                    <img src={smallBallShadow} alt="" />
                    <img src={bigBill} alt="" />
                    <img src={bigBillShadow} alt="" />
                    <div>
                        <img src={upperBodyCard} alt="" />
                        <img src={magneticStrip} alt="" />
            ...
            <section>
                <div>
                    ...
                    <p>Welcome to Finco! Start your journey to financial empowerment. Begin your exploration by clicking below. Let's navigate your financial future together</p>
                </div>
                <div>
                    <Link to={`/login`}>Skip</Link>
                    <Button btnContent={`Next &rarr;`} btnFunction={navigate("/get-started")}/>
                </div>
            </section>
